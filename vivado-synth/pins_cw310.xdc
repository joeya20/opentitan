...
## Buttons
set_property -dict { PACKAGE_PIN Y7 IOSTANDARD LVCMOS18 } [get_ports { POR_BUTTON_N }]; #pushbutton SW2     JA: done
...
set_property -dict { PACKAGE_PIN U9   IOSTANDARD LVCMOS18 } [get_ports { IOB6  }]; #   U9:USRDIP0                          DIP switches     JA: DONE
...
set_property -dict { PACKAGE_PIN V7   IOSTANDARD LVCMOS18 } [get_ports { IOB9  }]; #   V7:USRDIP1                          DIP switches     JA: DONE
set_property -dict { PACKAGE_PIN V8   IOSTANDARD LVCMOS18 } [get_ports { IOB10 }]; #   V8:USRDIP2                          DIP switches     JA: DONE
...
set_property -dict { PACKAGE_PIN W9          IOSTANDARD LVCMOS18                 } [get_ports { IOR5  }]; #  W9:USRDIP3   JA: DONE      
